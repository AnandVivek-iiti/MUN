...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* pt-20 / md:pt-16 clears the fixed navbar so the logo isn't clipped underneath it */}
      <div className="max-w-6xl mx-auto relative z-10 text-center w-full pt-20 md:pt-16">
