...
export function HeroSection() {
  ...
  return (
    <section
      id="home"
      // min-h-screen (not h-screen) + pt-20 lets the section grow past 100vh if needed,
      // and the top padding is applied to the FLEX CONTAINER, not the centered child —
      // this is what actually pushes content below the fixed navbar instead of just
      // nudging it by half the padding amount.
            ...
            >
              ...
              >
                <p className="text-base md:text-lg text-white/70">
                  Date To be announced • IIT Indore, Madhya Pradesh
                </p>
              </motion.div>
            </motion.div>
          )}
